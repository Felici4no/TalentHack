  ...
  <section className="py-24 px-8 bg-brand-black text-brand-offwhite">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="border-b md:border-b-0 md:border-r border-brand-offwhite/20 pb-12 md:pb-0 md:pr-12">
        ...
        <div className="pt-12 md:pt-0 md:pl-12">
          <SectionLabel className="mb-8 text-brand-gray-light/40">O que não somos</SectionLabel>
          <ul className="flex flex-col gap-6">
            {siteData.whatWeAre.isNot.map((item, i) => (
              <li key={i} className="text-xl md:text-3xl font-serif text-brand-gray-light/30 line-through">
                {item}
              </li>
            ))}
          </ul>
      ...
      <div className="mt-24 pt-12 border-t border-brand-offwhite/20 text-center">
