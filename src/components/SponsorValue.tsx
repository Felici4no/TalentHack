...
export const SponsorValueSection = () => (
  <section className="py-24 px-8 bg-brand-black text-brand-paper">
    <div className="max-w-7xl mx-auto">
      <SectionLabel className="text-brand-red mb-12">Valor para Patrocinadores</SectionLabel>
      <h2 className="text-4xl md:text-6xl font-serif max-w-4xl mb-8 leading-tight">
        {siteData.sponsorValueCards.title}
      </h2>
      <p className="text-xl md:text-2xl font-sans mb-6 max-w-3xl text-brand-sand">
        {siteData.sponsorValueCards.text}
      </p>
      <p className="text-lg font-sans mb-16 max-w-3xl uppercase tracking-widest font-semibold text-brand-red">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12 mb-24">
        {siteData.sponsorValueCards.cards.map((card, i) => (
          <div key={i} className="flex flex-col">
            <h3 className="text-xl font-serif mb-4 pb-4 border-b border-brand-sand/20">{card.title}</h3>
            <p className="font-sans text-brand-sand/80 leading-relaxed text-sm">{card.desc}</p>
          </div>
        ))}
      </div>

      <div className="text-center pt-12 border-t border-brand-sand/20">
        <p className="text-2xl md:text-4xl font-serif italic max-w-4xl mx-auto text-brand-paperLight">
...
export const SupportOptionsSection = () => (
  <section id="apoie" className="py-24 px-8 border-b border-brand-sand bg-brand-paper">
    <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
      ...
      <div className="flex-1 lg:max-w-md flex flex-col gap-8 justify-center bg-brand-paperLight p-12 border border-brand-sand/40">
