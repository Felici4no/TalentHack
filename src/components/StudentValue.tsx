...
export const StudentValueSection = () => (
  <section className="py-24 px-8 bg-brand-paper border-b border-brand-sand">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-16 gap-x-12">
        {siteData.studentValueCards.cards.map((card, i) => (
          <div key={i} className="flex flex-col">
            <h3 className="text-2xl font-serif mb-4 pb-4 border-b border-brand-sand">{card.title}</h3>
